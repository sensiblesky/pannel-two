<x-app-layout title="Create Customer" is-sidebar-open="true" is-header-blur="true">
        ...
        <div class="grid grid-cols-1 gap-4 sm:gap-5 lg:gap-6">
            <div>
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('users/customers-store') }}" class="space-y-4 p-4 sm:p-5">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                            <label class="block">
                                ...
                                <select name="source"
                                    ...
                                    <option value="widget" {{ old('source') === 'widget' ? 'selected' : '' }}>Widget</option>
                                    <option value="ticket" {{ old('source') === 'ticket' ? 'selected' : '' }}>Ticket</option>
