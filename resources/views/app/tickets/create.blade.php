        ...
        <div class="grid grid-cols-1 gap-4 sm:gap-5 lg:grid-cols-3 lg:gap-6">
            ...
            <div class="lg:col-span-2">
                <div class="card">
                    ...
                    <form id="create-ticket" method="POST" action="{{ route('tickets/store') }}" enctype="multipart/form-data" class="space-y-4 p-4 sm:p-5">
                        @csrf
                        ...
                        <div class="block" x-data="searchableSelect({
                            searchUrl: '{{ route('tickets/search-customers') }}',
                            name: 'customer_id',
                                ...
                                <div x-show="showCreateCustomer" x-transition.opacity
                                    ...
                                    <div x-show="showCreateCustomer" x-transition
                                        ...
                                        <div class="flex justify-end gap-2 border-t border-slate-200 px-6 py-4 dark:border-navy-500">
                                            ...
                                            <button type="button" @click="createCustomer('{{ route('tickets/quick-customer') }}')" :disabled="savingCustomer"
                        ...
                        <div class="flex justify-end space-x-2 pt-4">
                            <a href="{{ route('tickets/index') }}" class="btn space-x-2 border border-slate-300 font-medium text-slate-800 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-450 dark:text-navy-50 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90">Cancel</a>
                            ...
                            <div class="relative mt-1.5">
                                ...
                                <div class="relative">
                                    <input type="text"
                                           ...
                                           autocomplete="off">
                                    <button type="button" x-show="selectedId" @click="clear()" class="absolute inset-y-0 right-0 flex items-center pr-3 text-slate-400 hover:text-slate600 dark:hover:text-navy-200">
                                        <svg class="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
                                    </button>
                                </div>
                                <div x-show="selectedId && !open" class="mt-1">
